    ...
    <nav id="sidebar" class="sidebar" :class="{ 'collapsed': sidebarCollapsed }">
      <div class="sidebar-header">
        <div v-show="!sidebarCollapsed" class="d-flex align-items-center">
          <img src="@/assets/logo.png" alt="Logo" class="logo me-2" style="width: 40px; height: 40px; object-fit: contain;">
          <h4 class="mb-0">Daycare Business Plan</h4>
        </div>
        <div v-show="sidebarCollapsed" class="text-center">
          <img src="@/assets/logo.png" alt="Logo" class="logo" style="width: 30px; height: 30px; object-fit: contain;">
        </div>
      ...
      <header class="bg-primary text-white p-3 mb-4">
        <div class="container-fluid">
          <div class="d-flex align-items-center">
            <img src="@/assets/logo.png" alt="Logo" class="me-3" style="width: 50px; height: 50px; object-fit: contain;">
            <div>
